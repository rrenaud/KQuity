...
def parse_event_helper(line: str) -> GameEvent | None:
...
class MapStartEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, MapStartEvent)
...
class SpawnEventTest(GameEventTest):
    ...
    def test_modify_game_state(self) -> None:
        event = parse_event_helper('48009355,2023-02-27 06:42:20.193+00,spawn,"{9,True}",645988')
        assert event is not None
...
class BerryDepositEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, BerryDepositEvent)
...
class BerryKickInEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, BerryKickInEvent)
...
class BlessMaidenEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, BlessMaidenEvent)
...
class CarryFoodEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, CarryFoodEvent)
...
class GetOffSnailEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, GetOffSnailEvent)
...
class GetOnSnailEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, GetOnSnailEvent)
...
class SnailEatEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, SnailEatEvent)
...
class SnailEscapeEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, SnailEscapeEvent)
...
class PlayerKillEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, PlayerKillEvent)
    ...
    def test_modify_game_state(self) -> None:
        ...
        assert event is not None
        gs = GameState(self._map_structure_infos.get_map_info(Map.map_night, True))
...
class UseMaidenEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, UseMaidenEvent)
...
class VictoryEventTest(GameEventTest):
    def test_parse(self) -> None:
        ...
        assert event is not None
        assert isinstance(event, VictoryEvent)
...
class GetMapStartTest(unittest.TestCase):
    def test_find_map_start(self) -> None:
        ...
        non_none_events: list[GameEvent] = [e for e in input_events if e is not None]
        self.assertEqual(get_map_start(non_none_events), non_none_events[2])
...
class NormalizeTimestampsTest(unittest.TestCase):
    ...
    def test_normalize_timestamps(self) -> None:
        ...
        non_none_events: list[GameEvent] = [e for e in input_events if e is not None]
        normalized = normalize_times(non_none_events)
        self.assertLess(normalized[0].timestamp, 0)
        self.assertLess(normalized[1].timestamp, 0)
        self.assertEqual(normalized[2].timestamp, 0)
        self.assertGreater(normalized[3].timestamp, 0)
...
def make_full_worker() -> WorkerState:
...
class VectorizeSnailStateTest(GameEventTest):
    def test(self) -> None:
        def create_scenario(gold_on_left: bool, rider_position_id: int) -> tuple[GameState, list[GameEvent]]:
            ...
            non_none_events: list[GameEvent] = [e for e in raw_events if e is not None]
            events = normalize_times(non_none_events)
